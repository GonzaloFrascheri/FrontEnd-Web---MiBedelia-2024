                    ...
                    {estado.message === '' || estado.continuar === false  ? (
                        <form onSubmit={handleSubmit}>
                                <div className="card-body">
                                    {estado.message !== '' && (
                                        <div className="row">
                                            <div className="alert alert-icon m-2 alert-warning" role="alert">
                                        ...
                                        <div className="col-md-6">
                                            <div className="mb-3">
                                                ...
                                                <DatePicker
                                                    ...
                                                    minDate={periodoActivo.diaInicio}
                                                    maxDate={periodoActivo.diaFin}
                        ...
                        <div className="card-body">
                            <div className="alert alert-icon m-2 alert-primary" role="alert">
                                <div className="alert-icon-aside">
                                    <i className="far fa-flag"></i>
                                </div>
                                <div className="alert-icon-content">
