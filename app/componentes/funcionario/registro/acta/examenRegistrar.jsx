      ...
      try {
        ...
        const estudiantesProcesados = jsonData.slice(15).map(row => {
          ...
          if (!validNotas.includes(nota)) {
            throw new Error(
              `Nota inválida para el estudiante: ${row[1]} ${row[2]}, usted escribió: ( ${row[6]} ).`
            )
          }
          return {
            nombre: row[1],
  ...
  const enviarDatos = async () => {
    ...
    try {
      const { data, status } = await axios.put(
        'Funcionario/registrarActaExamen',
        datos
      )
      if (status === 200) {
        setIsLoading(false)
        setEstado({
          ...
          message:
            data.message +
            ' Se registró con éxito el acta para la asignatura: [' +
            examenDto.nombreAsignatura +
            '].',
          estado: data.evento
        })
      }
        ...
        <div className='card shadow-lg border-0 rounded-lg'>
          <div className='card-header justify-content-center'>
            <h3 className='fw-light'>
              {listasInfo.cu} | Registrar acta de examen para la asignatura:{' '}
                      ...
                      <div className='col'>
                        <div className='card-body py-5'>
                          ...
                          <p className='card-text'>
                            Verifique que los datos estén cargados correctamente
                            y haga clic en &quot;Confirmar&quot; para enviar los
                            datos.
                          </p>
                        </div>
                      </div>
                ...
                {errorMessage && (
                  <div className='alert alert-danger alert-icon' role='alert'>
                    ...
                    <div className='alert-icon-content'>
                      ...
                      Recuerde que las notas posibles son: APROBADO, A_EXAMEN,
                      REPROBADO.
                      <br />
                      Por favor, modifique nuevamenete el archivo descargado y
                      asegurese de utilziar este formato de nota.
                      <br />
                ...
                <div className='card card-icon'>
                  <div className='row no-gutters'>
                    ...
                    <div className='col'>
                      <div className='card-body py-5'>
                        <h5 className='card-title'>
                          Paso 3: Cargar el archivo excel con las notas
                        </h5>
                        <p className='card-text'>
                          <b>1ro.:</b> utilice el botón &quot;Descargar Planilla
                          en Excel&quot; y descarge el archivo en su equipo.
                        </p>
                        <p className='card-text'>
                          <b>2do.:</b> Modifique el archivo en su equipo,
                          cargando las notas correspondiente a cada estudiantes
                          en la columna &quot;Notas&quot;.
                        </p>
                        <p className='card-text'>
                          <b>3ro.:</b> utilice el botón &quot;Cargar Planilla
                          Excel&quot; para seleccionar el archivo descargado y
                          ya modificado, recuerde guardar los cambios.
                        </p>
                        <p className='card-text'>
                          <b>4to.:</b> Utilice el botón &quot;Analizar
                          Notas&quot; para procesar las notas y generar el acta
                          de examen.
                        </p>
                      </div>
                    </div>
                ...
                <div className='modal-content'>
                  <div className='modal-header'>
                    <h5 className='modal-title' id='staticBackdropLabel'>
                      Se estan enviando los datos, aguarde por favor...
                    </h5>
                  </div>
